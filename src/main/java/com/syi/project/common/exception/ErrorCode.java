...
public enum ErrorCode {
  ...
  FILE_NOT_IN_STORAGE_SINGLE("FILE_008", "저장소에서 파일을 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
  FILE_NOT_IN_STORAGE_BATCH("FILE_011", "선택된 일지 중 저장소에 파일이 없는 항목이 있습니다.", HttpStatus.NOT_FOUND),
