...
public class S3Uploader {
  ...
  @PostMapping("/upload")
  public String uploadFile(MultipartFile file, String dirName, LocalDate targetDate) throws IOException {
  ...
  // 파일 수정
  public String updateFile(MultipartFile newFile, String dirName, String oldFileUrl, LocalDate originalPostDate) throws IOException {
    try {
      // 1. 기존 파일 삭제
      ...
      // 2. 새 파일 업로드
      String newFileUrl = uploadFile(newFile, dirName, originalPostDate);
